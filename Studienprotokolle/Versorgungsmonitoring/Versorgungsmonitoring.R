...
if (exists("department_identifier", where = conf) && nchar(conf$department_identifier) >= 1) {
  Condition_department <- fhir_url(url = conf$serverbase,
                                    resource = "Condition",
                                    parameters = c("code"="D45,D47.3,D82.1,D83.0,D83.1,D83.2,D83.8,D83.9,D86,D86.0,D86.1,D86.2,D86.3,D86.8,D86.9,E03.0,E03.1,E84.0,E84.1,E84.80,E84.87,E84.88,E84.9,G21.0,G23.3,G54.5,H35.1,I73.1,I78.0,K62.7,L10.0,L13.0,L56.3,L63.0,L63.1,M08.2,M08.20,M08.21,M08.22,M08.23,M08.24,M08.25,M08.26,M08.27,M08.28,M08.29,M09.0,M09.00,M09.01,M09.02,M09.03,M09.04,M09.05,M09.06,M09.07,M09.08,M09.09,M31.3,M35.2,P27.1,Q00.1,Q17.2,Q23.4,Q28.21,Q71.6,Q72.7,Q79.0,Q85.1,Q91.0,Q91.1,Q91.2,Q91.4,Q91.5,Q91.6,Q91.7,Q97.0,C49.9,C56,C71.9,D12.6,D57.2,D81.8,D84.1,D84.8,E16.1,E70.0,E70.1,E70.3,E71.0,E71.1,E71.3,E72.0,E72.1,E72.2,E72.8,E74.0,E74.4,E74.8,E75.0,E75.1,E75.2,E75.4,E76.2,E77.1,E77.8,E78.6,E79.8,E83.0,E83.30,E83.31,E83.38,E83.39,E83.50,E83.58,E83.59,E85.3,F84.2,G10,G11.1,G11.2,G11.4,G11.8,G12.2,G23.1,G23.2,G24.1,G31.8,G40.3,G60.0,G60.8,G61.0,G70.0,G71.0,G71.1,G71.2,G71.8,H18.5,H35.5,I42.80,I42.88,M30.0,M33.0,M33.1,M33.2,M34.1,M35.8,M93.2,Q04.2,Q04.3,Q05.0,Q05.1,Q05.2,Q05.3,Q05.4,Q05.5,Q05.6,Q05.7,Q05.8,Q05.9,Q20.3,Q21.1,Q21.3,Q22.4,Q22.5,Q30.0,Q43.1,Q6.8,Q73.8,Q74.0,Q75.0,Q77.1,Q77.3,Q77.4,Q77.7,Q78.0,Q78.2,Q78.8,Q79.2,Q79.6,Q80.1,Q82.2,Q82.8,Q85.8,Q87.0,Q87.1,Q87.2,Q87.3,Q87.4,Q87.5,Q87.8,Q92.3,Q93.2,Q93.5,",
                                                   "_include" = "Condition:encounter",
                                                   "_include" = "Condition:class=stationaer",
                                                   "_include" = conf$department_identifier,
                                                   "_include" = "Condition:date=ge2017-01-01",
...
##################################################################################################################################################################################
design <- fhir_design(conditions,encounters,patients)

# download fhir bundles
bundles <- fhir_search(request = Condition_department, username = conf$username, password = conf$password, verbose = 1)
