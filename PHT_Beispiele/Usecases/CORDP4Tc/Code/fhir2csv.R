...
search_request <- paste0(fhir_api, # 'https://mii-agiop-cord.life.uni-leipzig.de/fhir/' or 'http://menzel.informatik.rwth-aachen.de:9012/fhir/' HAPI FHIR server end point
...
########################################################################################################################################################
write.csv(total, file = "./result.csv" , row.names = F)
########################################################################################################################################################
